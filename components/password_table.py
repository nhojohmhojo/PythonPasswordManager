...
from models import Passwords, Session  # Ensure this model exists with website, username, password fields
    ...
    def upload_csv(self):
        ...
        try:
            with open(file_path, newline='', encoding='utf-8') as csvfile:
                ...
                if headers:
                    ...
                    if not all(k in header_map for k in ["website", "username", "password"]):
                        messagebox.showerror("Error", "CSV must include columns for website, username, and password.")
                        return
            ...
            for row in rows:
                ...
                new_entry = Passwords(website=website, username=username, password=encrypted_password)
